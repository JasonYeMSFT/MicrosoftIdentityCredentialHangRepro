...
When running an aspnet core app in a Docker container, when attempting to acquiring the MicrosoftIdentityTokenCredential via Dependency Injection, the application hangs.
